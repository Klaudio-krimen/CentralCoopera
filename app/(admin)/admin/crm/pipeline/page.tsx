  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between animate-fade-up">
        <div>
          ...
          <p className="text-crm-muted text-sm mt-1">
            ...
            {openCount !== 1 ? "s" : ""} · {formatCurrency(totalOpen)} en juego
          </p>
        </div>
      </div>
      ...
      {stages.every((s) => s.deals.length === 0) ? (
        <div
          className="crm-card text-center py-16 animate-fade-up"
        ...
        >
          ...
          <p className="text-crm-muted text-sm mt-1">
            Crea un deal desde la ficha de un cliente en Clientes
          </p>
        </div>
      ) : (
        // Sin animate-fade-up acá a propósito: ese ancestro deja un
        // transform: translateY(0) permanente (fill-mode: both) que
        // desincroniza el cálculo de posición del cursor de dnd-kit
        // mientras se arrastra un deal — mismo mecanismo que atrapaba los
        // modales antes en esta sesión, pero aplicado al drag del Kanban.
        <div>
