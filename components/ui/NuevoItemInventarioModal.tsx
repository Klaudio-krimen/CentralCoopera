...
export default function NuevoItemInventarioModal() {
  ...
  const [form, setForm] = useState({ name: '', category: 'MATERIA_PRIMA', unit: 'kg' })
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative z-10 bg-white rounded-2xl shadow-[0_24px_48px_-12px_rgba(0,0,0,0.18)] w-full max-w-md p-6 animate-fade-up">
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-lg font-semibold text-zinc-900">Nuevo ítem de stock</h2>
              <button
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-1.5">
                  <label className="block text-sm font-medium text-zinc-700">Unidad</label>
                  <input
                    type="text"
                    value={form.unit}
              ...
              <p className="text-xs text-zinc-500">El stock inicial parte en 0. Ajústalo después del primer conteo.</p>
              ...
              <div className="flex gap-3 pt-1">
                ...
                >
                  {loading ? <SpinnerGap size={16} className="animate-spin" /> : 'Crear ítem'}
                </button>
              </div>
            </form>
          </div>
