  ...
  return (
    <div
      ...
      className={`flex flex-col min-w-[268px] w-[268px] shrink-0 rounded-2xl border transition-colors ${
        isOver ? 'bg-crm-secondary border-crm-primary/40' : 'bg-crm-secondary/60 border-crm-border'
      }`}
    >
      <div className="flex items-center gap-2 px-3 py-3 border-b border-crm-border">
        <span className="w-2.5 h-2.5 rounded-full shrink-0" style={{ backgroundColor: color }} />
        <h3 className="text-sm font-medium text-crm-foreground flex-1 truncate">{name}</h3>
