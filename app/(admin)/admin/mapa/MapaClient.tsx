...
const LeafletMap = dynamic(() => import("./LeafletMap"), {
  ssr: false,
  loading: () => (
    <div className="h-[70vh] w-full rounded-2xl bg-zinc-100 animate-pulse" />
  ),
});
    ...
    return (
      <div className="h-[70vh] w-full rounded-2xl border border-zinc-200 bg-white flex flex-col items-center justify-center">
        <p className="text-zinc-500 font-medium">
          Nadie en turno en este momento
        </p>
        <p className="text-zinc-400 text-sm mt-1">
          Cada chofer aparece cuando inicia su turno, y desaparece al terminarlo
        </p>
      </div>
    );
  }
    ...
    <div className="space-y-2">
      {error && (
        <p className="text-xs text-amber-600">
          Reconectando… mostrando la última información disponible.
        </p>
      )}
